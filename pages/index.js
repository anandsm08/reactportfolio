  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className=" dark:bg-gradient-to-b from-dark1 to-dark6">
        ...
        <section class="about-me"className="min-h-screen bg-gradient-to-b from-sky-100 to-sky-200 dark:bg-none">
          <div className="">
            <div className="flex justify-between">
              <div className="mx-10 justify-center dark:text-dark4">
                <h2 className="text-4xl font-mono py-10 px-28 dark:text-light">Who am I?</h2>
            ...
            <div className=" font-mono py-10 px-28 ml-10 text-gray-800 font-semibold ">
              ...
              <h3 className="text-xl underline dark:text-emerald-200 ">2020-2024</h3>
              ...
              <h3 className="text-xl underline dark:text-emerald-200">2018-2020</h3>
              <ul className="text-xl ml-10 py-2 list-disc dark:text-dark4">
                <li>
        ...
        >
          <div clasName="mx-10 justify-center">
            <h2 className="text-4xl font-mono py-10 px-28 dark:text-light">Projects</h2>
          </div>
                ...
                <div class="mt-6">
                  ...
                  <div class="flex justify-end py-2 ">
                    <div class="my-2">
                      ...
                      <a href="https://github.com/anandsm08/ExpenseTracker_Expensa"> <AiFillGithub className="h-8 w-8"></AiFillGithub></a>
                      </div>
                    </div>
            ...
            <div className="rounded-lg h-70 w-60 mx-10 dark:text-light">
              <div class="relative  py-6 px-6 rounded-3xl w-64 my-4 shadow-xl  backdrop-blur-lg bg-slate-300 dark:bg-dark5">
                ...
                <div class="mt-6">
                  ...
                  <div class="flex space-x-2 text-black text-sm py-2">
                    <AiFillCode className="h-6 w-6 dark:text-white"></AiFillCode>
                    <p className="text-lg dark:text-white">ReactJs | TailwindCSS</p>
                  </div>
                  ...
                  <div class="flex justify-end py-2 ">
                    ...
                    <div class="my-2 rounded-lg bg-white dark:text-black">
                     <a href="#"> <FiArrowUpRight className="h-8 w-8"></FiArrowUpRight></a>
                    </div>
                  </div>
                </div>
              </div>
